        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Exams_CourseSubjects_CourseSubjectId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AccountExams_CourseSubjects_CourseSubjectId",
                        column: x => x.CourseSubjectId,
                        principalTable: "CourseSubjects",
                        principalColumn: "CourseSubjectId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Registers_CourseSubjects_CourseSubjectId",
                        column: x => x.CourseSubjectId,
                        principalTable: "CourseSubjects",
                        principalColumn: "CourseSubjectId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AccountExams_CourseSubjectId",
                table: "AccountExams",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Registers_CourseSubjectId",
                table: "Registers",
                column: "CourseSubjectId");
